              ...
              <table className="min-w-full border-collapse border">
                <thead>
                  <tr className="bg-white">
                    ...
                    <th className="border p-2 text-black">Gains (MRU)</th>
                  </tr>
                </thead>
                <tbody>
                  {Object.keys(groupedSales[monthYear].days).map((day) => (
                    <tr key={day} className="border">
                      ...
                      <td className="border p-2 text-black">{groupedSales[monthYear].days[day].total} MRU</td>
                      <td className="border p-2 text-black">{groupedSales[monthYear].days[day].gain} MRU</td>
                    </tr>
                  ))}
