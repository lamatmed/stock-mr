        ...
        <table className="w-full border-collapse border border-gray-300 text-black">
          <thead>
            <tr className="bg-gray-200">
              ...
              <th className="border border-gray-300 px-4 py-2">Total Vente (Kz)</th>
              <th className="border border-gray-300 px-4 py-2">Gain (KZ)</th>
            </tr>
          </thead>
          <tbody>
        ...
        <table className="w-full border-collapse border border-gray-300 text-black">
          <thead>
            <tr className="bg-gray-200">
              ...
              <th className="border border-gray-300 px-4 py-2">Total Vente ()</th>
