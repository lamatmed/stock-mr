  ...
  const SalesHistory: React.FC<SalesHistoryProps> = ({ sales }) => {
    ...
    return (
      <div className="mt-6 bg-white p-6 rounded-lg shadow-md">
        <h2 className="text-xl font-bold text-blue-600 mb-4 text-right">إجمالي المبيعات والأرباح</h2>

        <h3 className="text-lg font-semibold text-black mb-2 text-right">حسب الشهر :</h3>
        <table className="w-full border-collapse border border-gray-300 text-black">
          <thead>
            <tr className="bg-gray-200">
              <th className="border border-gray-300 px-4 py-2">الشهر</th>
              <th className="border border-gray-300 px-4 py-2">إجمالي المبيعات (Kz)</th>
              <th className="border border-gray-300 px-4 py-2">الربح (KZ)</th>
            </tr>
          </thead>
          <tbody>
        ...
        <h3 className="text-lg font-semibold text-black mt-6 mb-2 text-right">حسب السنة :</h3>
        <table className="w-full border-collapse border border-gray-300 text-black">
          <thead>
            <tr className="bg-gray-200">
              <th className="border border-gray-300 px-4 py-2">السنة</th>
              <th className="border border-gray-300 px-4 py-2">إجمالي المبيعات (KZ)</th>
              <th className="border border-gray-300 px-4 py-2">الربح (KZ)</th>
            </tr>
          </thead>
