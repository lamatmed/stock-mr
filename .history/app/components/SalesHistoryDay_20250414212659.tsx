  ...
  return (
    <div className="mt-6 bg-white">
      {loading ? (
        ...
        <>
            <h2 className="text-xl font-bold text-black mb-4 text-right">إجمالي المبيعات والأرباح حسب الشهر واليوم :</h2>
            {Object.keys(groupedSales).map((monthYear) => (
              <div key={monthYear} className="mb-6">
                <h3 className="text-lg font-bold text-black mb-2 bg-gray-100 p-2 text-right">{monthYear}</h3>
                <table className="min-w-full border-collapse border">
                  <thead>
                    <tr className="bg-white">
                      <th className="border p-2 text-black text-right">التاريخ</th>
                      <th className="border p-2 text-black text-right">إجمالي المبيعات (Kz)</th>
                      <th className="border p-2 text-black text-right">الأرباح (Kz)</th>
                    </tr>
                  </thead>
                <tbody>
                  ...
                  <tr className="bg-gray-200 font-bold">
                    ...
                    <td className="border p-2 text-black">{groupedSales[monthYear].total} Kz</td>
                    <td className="border p-2 text-black">{groupedSales[monthYear].gain} Kz</td>
                  </tr>
                </tbody>
              </table>
            </div>
