    ...
    <div className="max-w-xl mx-auto p-6 bg-white mt-5">
      ...
      <div className="flex justify-between items-center mt-6" dir="rtl">
        <button
          ...
          className={`px-4 py-2 text-white rounded-lg ${currentPage === 1 ? "bg-gray-400 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-700"
            } flex items-center`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 text-white rounded-lg ${indexOfLastInvoice >= filteredInvoices.length
